...
import Events from "./Events/Events";
import SpecificEvents from "./Events/SpecificEvents";
import Fantasy_Leaderboard from "./Fantasy_Leaderboard";
import Homepage from "./Homepage";
import NewsPage from "./NewsPage";
import SpecificNewsPage from "./specificNewsPage";
import FollowTeam from "./FollowTeam";
...
function Fantasy_leaderboard_navigator() {
  return (
    <fantasy_leaderboard.Navigator>
      <fantasy_leaderboard.Screen
        name="FantasyLeaderboardStack"
        component={Fantasy_Leaderboard}
        options={{
          headerShown: false,
          // headerTitle: (props) => <Header />,
          headerStyle: { backgroundColor: "#111319", height: 100 },
...
export default function AllTabs() {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen name="       " component={Fantasy_leaderboard_navigator} />
      <Tab.Screen name="      " component={FollowTeam} />
    </Tab.Navigator>
  );
}
